...
bool px4_msgs__msg__raptor_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._raptor_input.RaptorInput", full_classname_dest, 38) == 0);
  }
  px4_msgs__msg__RaptorInput * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // linear_velocity
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT32);
      Py_ssize_t size = 3;
      float * dest = ros_message->linear_velocity;
      for (Py_ssize_t i = 0; i < size; ++i) {
        float tmp = *(npy_float32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(float));
      }
  ...
  {  // previous_action
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT32);
      Py_ssize_t size = 4;
      float * dest = ros_message->previous_action;
      for (Py_ssize_t i = 0; i < size; ++i) {
        float tmp = *(npy_float32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(float));
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__raptor_input__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RaptorInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._raptor_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RaptorInput");
  ...
  px4_msgs__msg__RaptorInput * ros_message = (px4_msgs__msg__RaptorInput *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // linear_velocity
    ...
    assert(sizeof(npy_float32) == sizeof(float));
    npy_float32 * dst = (npy_float32 *)PyArray_GETPTR1(seq_field, 0);
    float * src = &(ros_message->linear_velocity[0]);
    memcpy(dst, src, 3 * sizeof(float));
    Py_DECREF(field);
  }
  {  // angular_velocity
  ...
  {  // previous_action
    ...
    assert(sizeof(npy_float32) == sizeof(float));
    npy_float32 * dst = (npy_float32 *)PyArray_GETPTR1(seq_field, 0);
    float * src = &(ros_message->previous_action[0]);
    memcpy(dst, src, 4 * sizeof(float));
    Py_DECREF(field);
  }
