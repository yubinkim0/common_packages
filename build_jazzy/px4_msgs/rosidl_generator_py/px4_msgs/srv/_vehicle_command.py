...
class Metaclass_VehicleCommand_Event(type):
    """Metaclass of message 'VehicleCommand_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__vehicle_command__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__vehicle_command__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__vehicle_command__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__vehicle_command__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__vehicle_command__event
...
class VehicleCommand_Event(metaclass=Metaclass_VehicleCommand_Event):
    """Message class 'VehicleCommand_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<px4_msgs/VehicleCommand_Request, 1>',
        'response': 'sequence<px4_msgs/VehicleCommand_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['px4_msgs', 'srv'], 'VehicleCommand_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['px4_msgs', 'srv'], 'VehicleCommand_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from px4_msgs.srv import VehicleCommand_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, VehicleCommand_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'VehicleCommand_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from px4_msgs.srv import VehicleCommand_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, VehicleCommand_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'VehicleCommand_Response'"
...
class Metaclass_VehicleCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _vehicle_command.Metaclass_VehicleCommand_Event._TYPE_SUPPORT is None:
                _vehicle_command.Metaclass_VehicleCommand_Event.__import_type_support__()
...
class VehicleCommand(metaclass=Metaclass_VehicleCommand):
    ...
    from px4_msgs.srv._vehicle_command import VehicleCommand_Event as Event
