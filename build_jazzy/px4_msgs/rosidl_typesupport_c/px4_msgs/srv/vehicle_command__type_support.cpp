...
static const _VehicleCommand_Event_type_support_symbol_names_t _VehicleCommand_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, srv, VehicleCommand_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, srv, VehicleCommand_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, srv, VehicleCommand_Event)() {
  return &::px4_msgs::srv::rosidl_typesupport_c::VehicleCommand_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t VehicleCommand_service_type_support_handle = {
  ...
  &VehicleCommand_Request_message_type_support_handle,
  &VehicleCommand_Response_message_type_support_handle,
  &VehicleCommand_Event_message_type_support_handle,
